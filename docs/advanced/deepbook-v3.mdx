...
<Info>
  Unlike AMMs (Automated Market Makers like Uniswap), CLOBs use orderbooks where buyers and sellers place limit orders at specific prices.
</Info>
...
<Tip>
  **DeepMirror always uses DEEP tokens** (`payWithDeep: true`) for lower fees. Ensure you have DEEP balance!
</Tip>
...
<Warning>
  **Never use mainnet until officially announced.** DeepMirror is currently testnet-only.
</Warning>
...
<CardGroup cols={2}>
  ...
  <Card title="Sui Explorer" icon="magnifying-glass" href="https://testnet.suivision.xyz">
    View pools and transactions
  </Card>

  <Card title="DeepBook Testnet" icon="flask" href="https://testnet.deepbook.tech">
